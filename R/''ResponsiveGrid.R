...
''ResponsiveGrid <- function(children=NULL, id=NULL, allowOverlap=NULL, autoSize=NULL, breakpoints=NULL, cols=NULL, compactType=NULL, containerPadding=NULL, draggableCancel=NULL, draggableHandle=NULL, isBounded=NULL, isDraggable=NULL, isResizable=NULL, layout=NULL, layouts=NULL, margin=NULL, preventCollision=NULL, resizeHandles=NULL, rowHeight=NULL, transformScale=NULL, useCSSTransforms=NULL, width=NULL) {
    ...
    component <- list(
        ...
        propNames = c('children', 'id', 'allowOverlap', 'autoSize', 'breakpoints', 'cols', 'compactType', 'containerPadding', 'draggableCancel', 'draggableHandle', 'isBounded', 'isDraggable', 'isResizable', 'layout', 'layouts', 'margin', 'preventCollision', 'resizeHandles', 'rowHeight', 'transformScale', 'useCSSTransforms', 'width'),
