...
''ResponsiveGrid <- function(children=NULL, id=NULL, allowOverlap=NULL, autoSize=NULL, breakpoint=NULL, breakpoints=NULL, col=NULL, cols=NULL, compactType=NULL, containerPadding=NULL, draggableCancel=NULL, draggableHandle=NULL, droppedItem=NULL, isBounded=NULL, isDraggable=NULL, isDroppable=NULL, isResizable=NULL, layout=NULL, layouts=NULL, margin=NULL, preventCollision=NULL, resizeHandles=NULL, rowHeight=NULL, transformScale=NULL, useCSSTransforms=NULL, width=NULL) {
    ...
    component <- list(
        ...
        propNames = c('children', 'id', 'allowOverlap', 'autoSize', 'breakpoint', 'breakpoints', 'col', 'cols', 'compactType', 'containerPadding', 'draggableCancel', 'draggableHandle', 'droppedItem', 'isBounded', 'isDraggable', 'isDroppable', 'isResizable', 'layout', 'layouts', 'margin', 'preventCollision', 'resizeHandles', 'rowHeight', 'transformScale', 'useCSSTransforms', 'width'),
